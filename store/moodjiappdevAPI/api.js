...
const moodjiappdevAPI = axios.create({
  baseURL: "https://moodji-app-dev-88809.botics.co",
  headers: {
...
function rest_auth_password_reset_confirm_create(payload) {
  return moodjiappdevAPI.post(`/rest-auth/password/reset/confirm/`, payload.data);
}

function rest_auth_registration_verify_email_create(payload) {
  return moodjiappdevAPI.post(`/rest-auth/registration/verify-email/`, payload.data);
}
